!(function(t, e) {
  ...
  c.prototype = {
    validate: function(t, e) {
      ...
      {return (
        !t ||
          (!isNaN(t) &&
            ((t = parseFloat(t)), this.validateNumber.apply(this, arguments)))
      );
      }
  ...
  var f = function(t) {
    ...
    m = function(s, a) {
      return function(t) {
        ...
        {i[n - 1] = arguments[n];}
        return (
          i.pop(), a.apply(void 0, [t].concat(u(((r = s), i.map(d.parse[r])))))
        );
        var r;
      };
    },
  ...
  a.prototype = {
    init: function(t, e) {
      ...
      (this.validators = o({}, this.validators)),
      t)) {
    ...
    _setValidator: function(t, e, i) {
      for (var n in ("object" !== r(e) && (e = { fn: e, priority: i }),
    ...
    (v.Field = {
      ...
      _manageClassHandler: function() {
        ...
        if (
          ...
          if ("object" === r(t) && t instanceof jQuery && t.length) {
            return t;
          }
          t &&
            d.warn(
      ...
      return (
        ...
        this._withoutReactualizingFormOptions(function() {
          r.$element
            ...
            .not("[".concat(r.options.namespace, "excluded=true]"))
            .each(function(t, e) {
              var i = new window.Parsley.Factory(e, {}, r);
              if ("Field" === i.__class__ || "FieldMultiple" === i.__class__) {
                var n = i.__class__ + "-" + i.__id__;
                void 0 === r.fieldsMappedById[n] &&
                  ((r.fieldsMappedById[n] = i), r.fields.push(i));
              }
            }),
  ...
  b.prototype = {
    ...
    _validateConstraint: function(t, e) {
      var i = this,
        n = e.validate(t, this);
      return (
        !1 === n && (n = h.Deferred().reject()),
        d.all([n]).fail(function(t) {
  ...
  A.prototype = {
    ...
    bind: function(t, e) {
      ...
      switch (t) {
        ...
        case "parsleyField":
          i = h.extend(
            new b(this.element, this.domOptions, this.options, this.parent),
            new s(),
            window.ParsleyExtend
          );
          break;
  ...
  o(b.prototype, v.Field, s.prototype),
    o(y.prototype, v.Form, s.prototype),
    o(A.prototype, s.prototype),
    (h.fn.parsley = h.fn.psly = function(t) {
      ...
      if (0 != this.length) {
        return new A(this[0], t);
      }
    }),
    void 0 === window.ParsleyExtend && (window.ParsleyExtend = {}),
    (x.options = o(d.objectCreate(n), window.ParsleyConfig)),
    ...
    h.each("addError updateError".split(" "), function(t, a) {
      window.ParsleyUI[a] = function(t, e, i, n, r) {
        ...
        return (
          ...
          t[a](e, { message: i, assert: n, updateClass: s })
        );
      };
    }),
  ...
  return (
    ...
    (h.listenTo = function(t, e, i) {
      if ((P(), !(t instanceof b || t instanceof y))) {
    ...
    (h.unsubscribe = function(t, e) {
      if ((P(), "string" !== typeof t || "function" !== typeof e)) {
    ...
    h.extend(!0, x, {
      ...
      addAsyncValidator: function(t, e, i, n) {
        return (
          (x.asyncValidators[t] = { fn: e, url: i || !1, options: n || {} }),
          this
        );
      }
    }),
    x.addValidator("remote", {
      ...
      validateString: function(t, e, i, n) {
        ...
        (r = h.extend(!0, {}, { url: e, data: a, type: "GET" }, l)),
    ...
    new (function() {
      ...
      o(this, {
        ...
        behavesOk: function(t) {
          n.isNativeEvent(t) &&
            h(document)
              .off("input.inputevent", t.data.selector, n.behavesOk)
              .off("change.inputevent", t.data.selector, n.misbehaves);
        },
        install: function() {
